...
declare global {
  namespace defines {
    ...
    enum game_controller_interaction {
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.game_controller_interaction.always Online documentation}
       */
      always,
      /**
       * Never hover this element with a game controller.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.game_controller_interaction.never Online documentation}
       */
      never,
      /**
       * Hover according to the element type and implementation.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.game_controller_interaction.normal Online documentation}
       */
      normal,
    }
    enum group_state {
    ...
    enum inventory {
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.inventory.furnace_trash Online documentation}
       */
      furnace_trash,
      character_main,
      character_guns,
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.inventory.assembling_machine_dump Online documentation}
       */
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.inventory.assembling_machine_trash Online documentation}
       */
    ...
    enum logistic_section_type {
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.logistic_section_type.transitional_request_controlled Online documentation}
       */
      transitional_request_controlled,
      /**
       * Used by space platform hubs.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.logistic_section_type.request_missing_materials_controlled Online documentation}
       */
    ...
    enum print_skip {
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.print_skip.never Online documentation}
       */
      never,
      /**
       * Print will be skipped if same text was recently printed (within last 60 ticks). Used by most game messages.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.print_skip.if_redundant Online documentation}
       */
      if_redundant,
      /**
       * Print will be skipped if same text is still visible (printed within last 1152 ticks). Used by some notifications.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.print_skip.if_visible Online documentation}
       */
      if_visible,
    }
    enum print_sound {
     ...
     * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.prototypes Online documentation}
     */
    ...
    enum robot_order_type {
      /**
       * Construct a ghost.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.construct Online documentation}
       */
      construct,
      /**
       * Pickup an item.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.pickup Online documentation}
       */
      pickup,
      /**
       * Deliver an item.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.deliver Online documentation}
       */
      deliver,
      /**
       * Repair an entity.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.repair Online documentation}
       */
      repair,
      /**
       * Deconstruct an entity.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.deconstruct Online documentation}
       */
      deconstruct,
      /**
       * Deliver specific items to an entity (item request proxy).
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.deliver_items Online documentation}
       */
      deliver_items,
      /**
       * Upgrade an entity.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.upgrade Online documentation}
       */
      upgrade,
      /**
       * Explode a cliff.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.explode_cliff Online documentation}
       */
      explode_cliff,
      /**
       * Pickup items from an entity (item request proxy).
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.robot_order_type.pickup_items Online documentation}
       */
      pickup_items,
    }
    /**
     * The various parts of the launch sequence of the rocket silo.
     * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status Online documentation}
     */
    enum rocket_silo_status {
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.building_rocket Online documentation}
       */
      building_rocket,
      /**
       * The next state is `lights_blinking_open`. The rocket silo rocket entity gets created.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.create_rocket Online documentation}
       */
      create_rocket,
      /**
       * The next state is `doors_opening`. The rocket is getting prepared for launch.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.lights_blinking_open Online documentation}
       */
      lights_blinking_open,
      /**
       * The next state is `doors_opened`. The rocket is getting prepared for launch.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.doors_opening Online documentation}
       */
      doors_opening,
      /**
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.doors_opened Online documentation}
       */
      doors_opened,
      /**
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.rocket_rising Online documentation}
       */
      rocket_rising,
      /**
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.arms_advance Online documentation}
       */
      arms_advance,
      /**
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.rocket_ready Online documentation}
       */
      rocket_ready,
      /**
       * The next state is `launch_started`.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.launch_starting Online documentation}
       */
      launch_starting,
      /**
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.engine_starting Online documentation}
       */
      engine_starting,
      /**
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.arms_retract Online documentation}
       */
      arms_retract,
      /**
       * The next state is `lights_blinking_close`. The rocket is getting launched.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.rocket_flying Online documentation}
       */
      rocket_flying,
      /**
       * The next state is `doors_closing`.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.lights_blinking_close Online documentation}
       */
      lights_blinking_close,
      /**
       * The next state is `building_rocket`.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.doors_closing Online documentation}
       */
      doors_closing,
      /**
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.rocket_silo_status.launch_started Online documentation}
       */
      launch_started,
    }
    enum selection_mode {
     ...
     * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.signal_state Online documentation}
     */
    enum signal_state {
      /**
       * Green.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.signal_state.open Online documentation}
       */
      open,
      /**
       * Red.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.signal_state.closed Online documentation}
       */
      closed,
      /**
       * Orange.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.signal_state.reserved Online documentation}
       */
      reserved,
      /**
       * Red - From circuit network.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.signal_state.reserved_by_circuit_network Online documentation}
       */
    ...
    enum space_platform_state {
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.waiting_for_starter_pack Online documentation}
       */
      waiting_for_starter_pack,
      /**
       * Starter pack was requested from the logistics system.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.starter_pack_requested Online documentation}
       */
      starter_pack_requested,
      /**
       * Starter pack is on the way.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.starter_pack_on_the_way Online documentation}
       */
      starter_pack_on_the_way,
      /**
       * Following the path.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.on_the_path Online documentation}
       */
      on_the_path,
      /**
       * Platform is ready to leave this planet and does not accept deliveries.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.waiting_for_departure Online documentation}
       */
      waiting_for_departure,
      /**
       * Doesn't have any stations in schedule.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.no_schedule Online documentation}
       */
      no_schedule,
      /**
       * Doesn't have anywhere to go.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.no_path Online documentation}
       */
      no_path,
      /**
       * Waiting at a station.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.waiting_at_station Online documentation}
       */
      waiting_at_station,
      /**
       * Paused.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.space_platform_state.paused Online documentation}
       */
      paused,
    }
    enum target_type {
    ...
    enum train_state {
       ...
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.on_the_path Online documentation}
       */
      on_the_path,
      /**
       * Doesn't have anywhere to go.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.no_schedule Online documentation}
       */
      no_schedule,
      /**
       * Has no path and is stopped.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.no_path Online documentation}
       */
      no_path,
      /**
       * Braking before a rail signal.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.arrive_signal Online documentation}
       */
      arrive_signal,
      /**
       * Waiting at a signal.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.wait_signal Online documentation}
       */
      wait_signal,
      /**
       * Braking before a station.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.arrive_station Online documentation}
       */
      arrive_station,
      /**
       * Switched to manual control and has to stop.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.manual_control_stop Online documentation}
       */
      manual_control_stop,
      /**
       * Can move if user explicitly sits in and rides the train.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.manual_control Online documentation}
       */
      manual_control,
      /**
       * Waiting at a station.
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.wait_station Online documentation}
       */
      wait_station,
      /**
       * Same as no_path but all candidate train stops are full
       * @see {@link https://lua-api.factorio.com/2.0.47/defines.html#defines.train_state.destination_full Online documentation}
       */
      destination_full,
    }
    enum transport_line {
