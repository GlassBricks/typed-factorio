...
declare module "factorio:runtime" {
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapTick.html Online documentation}
     */
    export type MapTick = uint64;
    /**
     * The percentual increase of the attribute. A value of `0.6` means a 60% increase.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ModuleEffectValue.html Online documentation}
     */
     ...
     *   productivity=0.06,
     *   pollution=0.075}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ModuleEffects.html Online documentation}
     */
     ...
     * - `"≠"`: "not equal to"
     * - `"!="`: "not equal to"
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ComparatorString.html Online documentation}
     */
    export type ComparatorString = "=" | ">" | "<" | "≥" | ">=" | "≤" | "<=" | "≠" | "!=";
    /** @see ComparatorString */
    export type ComparatorStringRead = "=" | ">" | "<" | "≥" | "≤" | "≠";
    export type SpriteType = "item" | "entity" | "technology" | "recipe" | "fluid" | "tile" | "item-group" | "virtual-signal" | "shortcut" | "achievement" | "equipment" | "ammo-category" | "decorative" | "space-connection" | "space-location" | "surface" | "airborne-pollutant" | "asteroid-chunk" | "quality" | "file" | "utility";
    /**
     ...
     *
     * {@link https://lua-api.factorio.com/2.0.12/concepts/SpritePath.html > The supported types are:}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SpritePath.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/CollisionMask.html Online documentation}
     */
     ...
     * - `"switch"`
     * - `"label"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SimulationWidgetType.html Online documentation}
     */
    export type SimulationWidgetType = "signal-id" | "signal-id-base" | "signal-or-number" | "simple-slot" | "simple-item-slot" | "recipe-slot" | "quickbar-slot" | "logistics-button" | "logistics-button-space" | "text-button-localised-substring" | "text-button" | "text-button-substring" | "inventory-limit-slot-button" | "train-schedule-action-button" | "choose-button" | "textfield" | "item-group-tab" | "drop-down" | "check-box" | "switch" | "label";
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TrainPathRequestType.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TrainPathFinderGoal.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/PipeConnection.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EventFilter.html Online documentation}
     */
    export type EventFilter = LuaPrePlatformMinedEntityEventFilter[] | LuaRobotMinedEntityEventFilter[] | LuaEntityMarkedForUpgradeEventFilter[] | LuaPreGhostUpgradedEventFilter[] | LuaPlatformMinedEntityEventFilter[] | LuaScriptRaisedDestroyEventFilter[] | LuaPlayerBuiltEntityEventFilter[] | LuaPlatformBuiltEntityEventFilter[] | LuaPreGhostDeconstructedEventFilter[] | LuaEntityClonedEventFilter[] | LuaScriptRaisedTeleportedEventFilter[] | LuaEntityDeconstructionCancelledEventFilter[] | LuaRobotBuiltEntityEventFilter[] | LuaScriptRaisedBuiltEventFilter[] | LuaPrePlayerMinedEntityEventFilter[] | LuaPlayerRepairedEntityEventFilter[] | LuaUpgradeCancelledEventFilter[] | LuaSectorScannedEventFilter[] | LuaPostEntityDiedEventFilter[] | LuaEntityMarkedForDeconstructionEventFilter[] | LuaPlayerMinedEntityEventFilter[] | LuaEntityDamagedEventFilter[] | LuaScriptRaisedReviveEventFilter[] | LuaEntityDiedEventFilter[] | LuaPreRobotMinedEntityEventFilter[];
    /**
     * Write form of {@link EventFilter}, where table-or-array concepts are allowed to take an array form.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EventFilter.html Online documentation}
     */
    export type EventFilterWrite = readonly LuaPrePlatformMinedEntityEventFilter[] | readonly LuaRobotMinedEntityEventFilter[] | readonly LuaEntityMarkedForUpgradeEventFilter[] | readonly LuaPreGhostUpgradedEventFilter[] | readonly LuaPlatformMinedEntityEventFilter[] | readonly LuaScriptRaisedDestroyEventFilter[] | readonly LuaPlayerBuiltEntityEventFilter[] | readonly LuaPlatformBuiltEntityEventFilter[] | readonly LuaPreGhostDeconstructedEventFilter[] | readonly LuaEntityClonedEventFilter[] | readonly LuaScriptRaisedTeleportedEventFilter[] | readonly LuaEntityDeconstructionCancelledEventFilter[] | readonly LuaRobotBuiltEntityEventFilter[] | readonly LuaScriptRaisedBuiltEventFilter[] | readonly LuaPrePlayerMinedEntityEventFilter[] | readonly LuaPlayerRepairedEntityEventFilter[] | readonly LuaUpgradeCancelledEventFilter[] | readonly LuaSectorScannedEventFilter[] | readonly LuaPostEntityDiedEventFilter[] | readonly LuaEntityMarkedForDeconstructionEventFilter[] | readonly LuaPlayerMinedEntityEventFilter[] | readonly LuaEntityDamagedEventFilterWrite[] | readonly LuaScriptRaisedReviveEventFilter[] | readonly LuaEntityDiedEventFilter[] | readonly LuaPreRobotMinedEntityEventFilter[];
    /**
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/RegistrationTarget.html Online documentation}
     */
    export type RegistrationTarget = LuaEntity | LuaEquipment | LuaEquipmentGrid | LuaItem | LuaLogisticCell | LuaLogisticNetwork | LuaLogisticSection | LuaPermissionGroup | LuaPlanet | LuaPlayer | LuaRailPath | LuaRenderObject | LuaSpacePlatform | LuaSurface | LuaTrain | LuaCommandable | LuaCustomChartTag | LuaGuiElement;
    /**
    ...
    export interface BaseUndoRedoAction {
         ...
         */
        type: "built-entity" | "removed-entity" | "built-tile" | "removed-tile" | "upgraded-entity" | "upgraded-modules" | "wire-added" | "wire-removed" | "rotated-entity" | "copy-entity-settings";
        /**
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/UndoRedoAction.html Online documentation}
     */
    export type UndoRedoAction = BuiltEntityUndoRedoAction | RemovedEntityUndoRedoAction | BuiltTileUndoRedoAction | RemovedTileUndoRedoAction | UpgradedEntityUndoRedoAction | UpgradedModulesUndoRedoAction | WireAddedUndoRedoAction | WireRemovedUndoRedoAction | RotatedEntityUndoRedoAction | CopyEntitySettingsUndoRedoAction;
     ...
     * - `"explosion"`
     * - `"enemy"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SoundType.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SelectionModeFlags.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ItemPrototypeFlags.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ItemPrototypeFlag.html Online documentation}
     */
    export type ItemPrototypeFlag = "draw-logistic-overlay" | "excluded-from-trash-unrequested" | "always-show" | "hide-from-bonus-gui" | "hide-from-fuel-tooltip" | "not-stackable" | "primary-place-result" | "mod-openable" | "only-in-cursor" | "spawnable" | "spoil-result" | "ignore-spoil-time-modifier";
    /**
     * ## Union members
     * - `"none"`
     * - `"whitelist"`
     * - `"blacklist"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/PrototypeFilterMode.html Online documentation}
     */
     ...
     * @example
     * "is_lower_object"
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/CollisionLayerID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/PrototypeFilter.html Online documentation}
     */
    export type PrototypeFilter = ModSettingPrototypeFilter[] | TilePrototypeFilter[] | DecorativePrototypeFilter[] | RecipePrototypeFilter[] | AchievementPrototypeFilter[] | TechnologyPrototypeFilter[] | AsteroidChunkPrototypeFilter[] | ItemPrototypeFilter[] | EquipmentPrototypeFilter[] | EntityPrototypeFilter[] | SpaceLocationPrototypeFilter[] | FluidPrototypeFilter[];
    /**
     * Write form of {@link PrototypeFilter}, where table-or-array concepts are allowed to take an array form.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/PrototypeFilter.html Online documentation}
     */
    export type PrototypeFilterWrite = readonly ModSettingPrototypeFilter[] | readonly TilePrototypeFilterWrite[] | readonly DecorativePrototypeFilter[] | readonly RecipePrototypeFilterWrite[] | readonly AchievementPrototypeFilter[] | readonly TechnologyPrototypeFilterWrite[] | readonly AsteroidChunkPrototypeFilter[] | readonly ItemPrototypeFilterWrite[] | readonly EquipmentPrototypeFilter[] | readonly EntityPrototypeFilterWrite[] | readonly SpaceLocationPrototypeFilterWrite[] | readonly FluidPrototypeFilterWrite[];
    /**
     * @see DisplayPanelMessageDefinitionWrite
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/DisplayPanelMessageDefinition.html Online documentation}
     */
     ...
     * - `"asteroid-chunk"`
     * - `"quality"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SignalIDType.html Online documentation}
     */
     ...
     * - `"play-previous-track"`
     * - `"pause-resume-music"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LinkedGameControl.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ResearchTrigger.html Online documentation}
     */
    export type ResearchTrigger = CraftItemResearchTrigger | MineEntityResearchTrigger | CraftFluidResearchTrigger | CaptureSpawnerResearchTrigger | BuildEntityResearchTrigger | SendItemToOrbitResearchTrigger | OtherResearchTrigger;
    /**
     * A set of flags. Active flags are in the dictionary as `true`, while inactive flags aren't present at all.
     *
     * By default, none of these flags are set.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EntityPrototypeFlags.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EntityPrototypeFlag.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ProgrammableSpeakerPlaybackMode.html Online documentation}
     */
     ...
     * - `"south-to-none"`
     * - `"none-to-north"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/CliffOrientation.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/BlueprintInsertPlan.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Offer.html Online documentation}
     */
     ...
     * @see ItemFilterWrite
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ItemFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ScheduleRecord.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GuiArrowSpecification.html Online documentation}
     */
     ...
     * @see Vector3DArray
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Vector3D.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Vector3D.html Online documentation}
     */
    export type Vector3DArray = readonly [
        float,
        float,
        float
    ];
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TrainSchedule.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/PlatformSchedule.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/RecipeIDAndQualityIDPair.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ForceID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/FluidID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EntityWithQualityID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EntityIDAndQualityIDPair.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ItemWithQualityID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ItemIDAndQualityIDPair.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ItemID.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EntityID.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TechnologyID.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ParticleID.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/DamageTypeID.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TrivialSmokeID.html Online documentation}
     */
     ...
     * - `"right"`
     * - `"center"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TextAlign.html Online documentation}
     */
     ...
     * - `"baseline"`
     * - `"bottom"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/VerticalTextAlign.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/QualityID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/RecipeID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TileID.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EquipmentID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EquipmentWithQualityID.html Online documentation}
     */
    export type EquipmentWithQualityID = LuaEquipmentPrototype | LuaEquipment | string | EquipmentIDAndQualityIDPair;
    /**
     * An equipment prototype with optional quality specification.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EquipmentIDAndQualityIDPair.html Online documentation}
     */
     ...
     * -- Shorthand
     * {{-2, -3}, {5, 8}}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/BoundingBox.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SpacePlatformIdentification.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/DecorativeID.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/AsteroidChunkID.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SpaceLocationID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SignalFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LogisticFilter.html Online documentation}
     */
     ...
     * - `string`: The prototype name.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SurfacePropertyID.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ScriptRenderTarget.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ScriptRenderTargetTable.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/QualityCondition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/RangeMode.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/BlueprintEntity.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MathExpression.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Product.html Online documentation}
     */
     ...
     * -- minimum amount of 1 and a maximum amount of 5
     * {{type="item", name="custom-item", probability=0.5, amount_min=1, amount_max=5}}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ItemProduct.html Online documentation}
     */
     ...
     *   {type="fluid", name="light-oil", amount=4.5},
     *   {type="fluid", name="petroleum-gas", amount=5.5}}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/FluidProduct.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/AutoplaceSpecification.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/CliffPlacementSettings.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/AutoplaceSettings.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapGenSettings.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/PollutionMapSettings.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EnemyEvolutionMapSettings.html Online documentation}
     */
     ...
     * ```
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EnemyExpansionMapSettings.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/DifficultySettings.html Online documentation}
     */
    export interface DifficultySettings {
        /**
         * A value in range [0.001, 1000].
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/DifficultySettings.technology_price_multiplier.html Online documentation}
         */
        technology_price_multiplier: double;
        /**
         * A value in range [0.01, 100].
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/DifficultySettings.spoil_time_modifier.html Online documentation}
         */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapAndDifficultySettings.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapSettings.html Online documentation}
     */
    export interface MapSettings {
        ...
        /**
         * If a behavior fails this many times, the enemy (or enemy group) is destroyed. This solves biters getting stuck within their own base.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapSettings.max_failed_behavior_count.html Online documentation}
         */
        max_failed_behavior_count: uint;
    }
    /**
     * @see BlueprintScheduleRecordWrite
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/BlueprintScheduleRecord.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/BlueprintScheduleInterrupt.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/BlueprintSchedule.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/WaitCondition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/CursorBoxRenderType.html Online documentation}
     */
    export type CursorBoxRenderType = "entity" | "multiplayer-entity" | "electricity" | "copy" | "not-allowed" | "pair" | "logistics" | "train-visualization" | "blueprint-snap-rectangle" | "spidertron-remote-selected" | "spidertron-remote-to-be-selected";
    /**
     * What is shown in the map view. If a field is not given, that setting will not be changed.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapViewSettings.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ElemType.html Online documentation}
     */
    export type ElemType = "achievement" | "decorative" | "entity" | "equipment" | "fluid" | "item" | "item-group" | "recipe" | "signal" | "technology" | "tile" | "asteroid-chunk" | "space-location" | "item-with-quality" | "entity-with-quality" | "recipe-with-quality" | "equipment-with-quality";
    /**
     ...
     * - `"right"`
     * - `"none"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SwitchState.html Online documentation}
     */
     ...
     * - `"camera-effect"`
     * - `"activate-impact"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TriggerEffectItemType.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TriggerTargetMask.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LocalisedString.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/RealOrientation.html Online documentation}
     */
     ...
     * -- Shorthand
     * {1.625, 2.375}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapPosition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ChunkPosition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TilePosition.html Online documentation}
     */
     ...
     * -- Shorthand
     * {1, 2}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EquipmentPosition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GuiLocation.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ChunkPositionAndArea.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EquipmentPoint.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Tags.html Online documentation}
     */
     ...
     * @example
     * right = {1.0, 0.0}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Vector.html Online documentation}
     */
    export type Vector = MapPositionArray;
    /**
     * An area defined using the map editor.
     * @see ScriptAreaWrite
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ScriptArea.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ScriptPosition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Color.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ColorModifier.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/AsteroidChunk.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ChartTagSpec.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.html Online documentation}
     */
    export interface GameViewSettings {
        /**
         * Show the controller GUI elements. This includes the toolbar, the selected tool slot, the armour slot, and the gun and ammunition slots.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_controller_gui.html Online documentation}
         */
        show_controller_gui: boolean;
        /**
         * Show the chart in the upper right-hand corner of the screen.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_minimap.html Online documentation}
         */
        show_minimap: boolean;
        /**
         * Show research progress and name in the upper right-hand corner of the screen.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_research_info.html Online documentation}
         */
        show_research_info: boolean;
        /**
         * Show overlay icons on entities. Also known as "alt-mode".
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_entity_info.html Online documentation}
         */
        show_entity_info: boolean;
        /**
         * Show the flashing alert icons next to the player's toolbar.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_alert_gui.html Online documentation}
         */
        show_alert_gui: boolean;
        /**
         * When `true` (the default), mousing over an entity will select it. Otherwise, moving the mouse won't update entity selection.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.update_entity_selection.html Online documentation}
         */
        update_entity_selection: boolean;
        /**
         * When `true` (`false` is default), the rails will always show the rail block visualisation.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_rail_block_visualisation.html Online documentation}
         */
        show_rail_block_visualisation: boolean;
        /**
         * Shows or hides the buttons row.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_side_menu.html Online documentation}
         */
        show_side_menu: boolean;
        /**
         * Shows or hides the view options when map is opened.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_map_view_options.html Online documentation}
         */
        show_map_view_options: boolean;
        /**
         * Shows or hides the tooltip that is displayed when selecting an entity.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_entity_tooltip.html Online documentation}
         */
        show_entity_tooltip: boolean;
        /**
         * Shows or hides quickbar of shortcuts.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_quickbar.html Online documentation}
         */
        show_quickbar: boolean;
        /**
         * Shows or hides the shortcut bar.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_shortcut_bar.html Online documentation}
         */
        show_shortcut_bar: boolean;
        /**
         * Shows or hides the crafting queue.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_crafting_queue.html Online documentation}
         */
        show_crafting_queue: boolean;
        /**
         * Shows or hides the tool window with the weapons and armor.
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_tool_bar.html Online documentation}
         */
         ...
         * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GameViewSettings.show_hotkey_suggestions.html Online documentation}
         */
        show_hotkey_suggestions: boolean;
    }
    /**
     * The data that can be extracted from a map exchange string, as a plain table.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapExchangeStringData.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/BlueprintWire.html Online documentation}
     */
    ...
    /**
     * @see TileWrite
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Tile.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Ingredient.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TechnologyModifier.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/NoiseExpression.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MapGenSize.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/AutoplaceControl.html Online documentation}
     */
     ...
     *
     * {@link https://lua-api.factorio.com/2.0.12/concepts/PropertyExpressionNames.html > Values either name a NamedNoiseExpression or can be literal numbers, stored as strings (e.g. `5`). All other controls can be overridden by a property expression names. Notable properties:}
     *
     * {@link https://lua-api.factorio.com/2.0.12/concepts/PropertyExpressionNames.html > Climate controls ('Moisture' and 'Terrain type' at the bottom of the Terrain tab in the map generator GUI) don't have their own dedicated structures in MapGenSettings. Instead, their values are stored as property expression overrides with long names:}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/PropertyExpressionNames.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Signal.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/UpgradeMapperSource.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/InfinityInventoryFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/InfinityPipeFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/HeatSetting.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/CircuitCondition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/CircuitConditionDefinition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Command.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SimpleItemStack.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SurfaceIdentification.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/PlayerIdentification.html Online documentation}
     */
     ...
     * - {@link LuaItemStack}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ItemStackIdentification.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TargetType.html Online documentation}
     */
     ...
     *
     * {@link https://lua-api.factorio.com/2.0.12/concepts/SoundPath.html > The utility and ambient types each contain general use sound prototypes defined by the game itself.}
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SoundPath.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/AttackParameters.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/CapsuleAction.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/AnyBasic.html Online documentation}
     */
    export type AnyBasic = string | boolean | number | table;
    /**
     * Any basic type (string, number, boolean), table, or LuaObject.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Any.html Online documentation}
     */
     ...
     * - `"bottom-right"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/Alignment.html Online documentation}
     */
    ...
    /**
     * Information about the event that has been raised. The table can also contain other fields depending on the type of event. See {@linkplain https://lua-api.factorio.com/2.0.12/events.html the list of Factorio events} for more information on these.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EventData.html Online documentation}
     */
     ...
     * - `"button-8"`
     * - `"button-9"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/MouseButtonFlags.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ForceCondition.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GuiElementType.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GuiArrowType.html Online documentation}
     */
     ...
     * - `"horizontal"`
     * - `"vertical"`
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/GuiDirection.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ScrollPolicy.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/float.html Online documentation}
     */
    export type float = number;
    /**
     * A double-precision floating-point number. This is the same data type as all Lua numbers use.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/double.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/int.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/int8.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/uint.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/uint8.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/uint16.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/uint64.html Online documentation}
     */
    export type uint64 = number;
    /**
     * Nil is the type of the value `nil`, whose main property is to be different from any other value. It usually represents the absence of a useful value.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/nil.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/table.html Online documentation}
     */
    export type table = object;
    /**
     * Any LuaObject listed on the {@linkplain https://lua-api.factorio.com/2.0.12/classes.html Classes} page.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaObject.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/ModSettingPrototypeFilter.html Online documentation}
     */
    ...
    export interface BaseTilePrototypeFilter {
         ...
         * The condition to filter on.
         */
        readonly filter: "minable" | "autoplace" | "blueprintable" | "item-to-place" | "collision-mask" | "walking-speed-modifier" | "vehicle-friction-modifier" | "decorative-removal-probability" | "absorptions-per-second";
        /**
         * How to combine this with the previous filter. Defaults to `"or"`. When evaluating the filters, `"and"` has higher precedence than `"or"`.
         */
        readonly mode?: "or" | "and";
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TilePrototypeFilter.html Online documentation}
     */
    export type TilePrototypeFilter = CollisionMaskTilePrototypeFilter | WalkingSpeedModifierTilePrototypeFilter | VehicleFrictionModifierTilePrototypeFilter | DecorativeRemovalProbabilityTilePrototypeFilter | AbsorptionsPerSecondTilePrototypeFilter | OtherTilePrototypeFilter;
    /**
     * Write form of {@link TilePrototypeFilter}, where table-or-array concepts are allowed to take an array form.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TilePrototypeFilter.html Online documentation}
     */
    export type TilePrototypeFilterWrite = CollisionMaskTilePrototypeFilter | WalkingSpeedModifierTilePrototypeFilterWrite | VehicleFrictionModifierTilePrototypeFilterWrite | DecorativeRemovalProbabilityTilePrototypeFilterWrite | AbsorptionsPerSecondTilePrototypeFilterWrite | OtherTilePrototypeFilter;
    /**
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/DecorativePrototypeFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/RecipePrototypeFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/AchievementPrototypeFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/TechnologyPrototypeFilter.html Online documentation}
     */
    ...
    export interface BaseItemPrototypeFilter {
         ...
         * The condition to filter on.
         */
        readonly filter: "tool" | "mergeable" | "hidden" | "hidden-in-factoriopedia" | "is-parameter" | "item-with-inventory" | "selection-tool" | "item-with-label" | "has-rocket-launch-products" | "fuel" | "place-result" | "burnt-result" | "place-as-tile" | "placed-as-equipment-result" | "name" | "type" | "flag" | "subgroup" | "fuel-category" | "stack-size" | "fuel-value" | "fuel-acceleration-multiplier" | "fuel-top-speed-multiplier" | "fuel-emissions-multiplier";
        /**
         * How to combine this with the previous filter. Defaults to `"or"`. When evaluating the filters, `"and"` has higher precedence than `"or"`.
         */
        readonly mode?: "or" | "and";
    ...
    export interface OtherItemPrototypeFilter extends BaseItemPrototypeFilter {
        readonly filter: "tool" | "mergeable" | "hidden" | "hidden-in-factoriopedia" | "is-parameter" | "item-with-inventory" | "selection-tool" | "item-with-label" | "has-rocket-launch-products" | "fuel";
    }
    /**
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/EquipmentPrototypeFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SpaceLocationPrototypeFilter.html Online documentation}
     */
    export type SpaceLocationPrototypeFilter = TypeSpaceLocationPrototypeFilter | SolarPowerInSpaceSpaceLocationPrototypeFilter | OtherSpaceLocationPrototypeFilter;
    /**
     * Write form of {@link SpaceLocationPrototypeFilter}, where table-or-array concepts are allowed to take an array form.
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/SpaceLocationPrototypeFilter.html Online documentation}
     */
    export type SpaceLocationPrototypeFilterWrite = TypeSpaceLocationPrototypeFilter | SolarPowerInSpaceSpaceLocationPrototypeFilterWrite | OtherSpaceLocationPrototypeFilter;
    /**
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/FluidPrototypeFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPrePlatformMinedEntityEventFilter.html Online documentation}
     */
    export type LuaPrePlatformMinedEntityEventFilter = TypePrePlatformMinedEntityEventFilter | NamePrePlatformMinedEntityEventFilter | GhostTypePrePlatformMinedEntityEventFilter | GhostNamePrePlatformMinedEntityEventFilter | OtherPrePlatformMinedEntityEventFilter;
    /**
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaRobotMinedEntityEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaEntityMarkedForUpgradeEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPreGhostUpgradedEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPlatformMinedEntityEventFilter.html Online documentation}
     */
    export type LuaPlatformMinedEntityEventFilter = TypePlatformMinedEntityEventFilter | NamePlatformMinedEntityEventFilter | GhostTypePlatformMinedEntityEventFilter | GhostNamePlatformMinedEntityEventFilter | OtherPlatformMinedEntityEventFilter;
    /**
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaScriptRaisedDestroyEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPlayerBuiltEntityEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPlatformBuiltEntityEventFilter.html Online documentation}
     */
    export type LuaPlatformBuiltEntityEventFilter = TypePlatformBuiltEntityEventFilter | NamePlatformBuiltEntityEventFilter | GhostTypePlatformBuiltEntityEventFilter | GhostNamePlatformBuiltEntityEventFilter | ForcePlatformBuiltEntityEventFilter | OtherPlatformBuiltEntityEventFilter;
    /**
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPreGhostDeconstructedEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaEntityClonedEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaScriptRaisedTeleportedEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaEntityDeconstructionCancelledEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaRobotBuiltEntityEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaScriptRaisedBuiltEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPrePlayerMinedEntityEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPlayerRepairedEntityEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaUpgradeCancelledEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaSectorScannedEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPostEntityDiedEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaEntityMarkedForDeconstructionEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPlayerMinedEntityEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaEntityDamagedEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaScriptRaisedReviveEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaEntityDiedEventFilter.html Online documentation}
     */
     ...
     * @see {@link https://lua-api.factorio.com/2.0.12/concepts/LuaPreRobotMinedEntityEventFilter.html Online documentation}
     */
